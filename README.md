...
You want perl to extract the data, but you also want the singlet doublet data on a single line because that's easy to work with in excel.  The output data would look like this (just capturing electronic energy here).
